...
import tech.boshu.changjiangshidai.ui.activity.stockinfo.purchasereturnhistory.PurchaseHistoryPrOrder;
/**
 * Created by Administrator on 2016/1/7.
 */
public class PurchaseReturnHistoryAdapter extends CommonAdapter<PurchaseHistoryPrOrder> {

    public PurchaseReturnHistoryAdapter(Context context, List<PurchaseHistoryPrOrder> datas) {
        super(context, datas);
