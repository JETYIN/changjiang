...
public class MyPopupPurchaseDetail extends PopupWindow {

	private Context context;
	private PopupMenuClickListener listener;

	public MyPopupPurchaseDetail(Context context){
		this.context=context;
		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View conentView = inflater.inflate(R.layout.layout_popup_purchase_detail, null);
		iniView(conentView);
		...
		conentView.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				MyPopupPurchaseDetail.this.dismiss();
				return false;
			}
		});
	}
	...
	private void iniView(View conentView) {
		...
		conentView.findViewById(R.id.supplier).setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				listener.onPopueMenuItemClick(v.getId());
			}
		});
		conentView.findViewById(R.id.purchase).setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				listener.onPopueMenuItemClick(v.getId());
			}
