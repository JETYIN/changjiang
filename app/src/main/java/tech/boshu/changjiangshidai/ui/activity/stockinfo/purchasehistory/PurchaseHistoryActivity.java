...
import tech.boshu.changjiangshidai.ui.activity.stockinfo.finishpurchaseorderdetail.FinishPurchaseOrderDetailActivity;
...
public class PurchaseHistoryActivity extends SwipeRefreshBaseActivity implements IPurchaseHistoryView {
    ...
    public void bindDatas(List<PurchaseHistoryPrOrder> datas) {
        ...
        if (adapter == null) {
            adapter = new PurchaseHistoryAdapter(mContext, datas);
