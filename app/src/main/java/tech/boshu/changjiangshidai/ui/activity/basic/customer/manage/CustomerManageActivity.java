...
import tech.boshu.changjiangshidai.adapter.CustomerManageAdapter;
...
import tech.boshu.changjiangshidai.ui.activity.basic.customer.addoredit.AddOrEditCustomerActivity;
 ...
 */
public class CustomerManageActivity extends BaseActivity implements
        CustomerManageAdapter.CustomerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CustomerManageAdapter(mContext, datas, this);
    ...
    protected void setLayoutResId() {
        this.layoutResId = R.layout.activity_customer_manage;
    }
