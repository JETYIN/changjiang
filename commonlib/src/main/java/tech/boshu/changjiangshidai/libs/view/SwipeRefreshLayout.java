...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    private SwipeRefreshCircleImageView mCircleView;
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        SwipyRefreshLayoutDirection direction
                = SwipyRefreshLayoutDirection.getFromInt(a2.getInt(R.styleable
                .SwipyRefreshLayout_direction, 0));
    ...
    private void createProgressView() {
        mCircleView = new SwipeRefreshCircleImageView(getContext(), CIRCLE_BG_LIGHT,
                CIRCLE_DIAMETER / 2);
...
//
//                    boolean res = absListView.getChildAt(lastIndex).getBottom() == absListView
// .getPaddingBottom();
//
//                    return res;
//                }
